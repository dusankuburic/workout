...
static bool descriptor_table_simple_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_simple_2eproto = {
  &descriptor_table_simple_2eproto_initialized, descriptor_table_protodef_simple_2eproto, "simple.proto", 121,
...
static bool dynamic_init_dummy_simple_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_simple_2eproto), true);
namespace example {
namespace simple {
...
SimpleMessage::SimpleMessage()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:example.simple.SimpleMessage)
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          is_simple_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string name = 3;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          _internal_add_sample_list(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void SimpleMessage::InternalSwap(SimpleMessage* other) {
  ...
  name_.Swap(&other->name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(id_, other->id_);
  swap(is_simple_, other->is_simple_);
}
...
template<> PROTOBUF_NOINLINE ::example::simple::SimpleMessage* Arena::CreateMaybeMessage< ::example::simple::SimpleMessage >(Arena* arena) {
  return Arena::CreateInternal< ::example::simple::SimpleMessage >(arena);
}
