...
void DisplayUnorderMap(unordered_map<T1, T2>& cont)
{
	cout << "Unorder Map contians: " << endl;
	...
	cout << "Bucket cont = " << cont.bucket_count() << endl;
	cout << "Current load factor: " << cont.load_factor() << endl;
	cout << "Mak load factor = " << cont.max_load_factor() << endl;
}
...
int main() {
	...
	DisplayUnorderMap<int, string>(umapIntToStr);
